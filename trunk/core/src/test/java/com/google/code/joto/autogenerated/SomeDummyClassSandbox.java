...
instancesMap.registerInstance( 33311724, obj);  /* @1fc4bec */
obj.setInteger(56);
...
instancesMap.registerInstance( 19621457, obj);  /* @12b6651 */
...
array[0] = 13;
array[1] = new Date(1252204124762L) /* Sat Sep 05 23:28:44 GMT-03:00 2009*/ ;
array[2] = "lolo";
array[3] = CodeType.RC;
...
instancesMap.registerInstance( 23660326, obj);  /* @1690726 */
obj.setCommission(0.0);
obj.setTAXCommissionApplicable(true);
return obj;
}}.create();
array[7] = (Vendor) instancesMap.getInstance( 19621457) /* @12b6651 */ ;
return array;
}}.create());
...
col.add((Vendor) instancesMap.getInstance( 19621457) /* @12b6651 */ );
col.add(123);
return col;
}}.create());
