...
public class CompilationUnitScanner {
	...
	protected void recursiveScanCompilationUnits(IProgressMonitor monitor, IJavaElement[] elts) throws Exception {
		for (IJavaElement elt : elts) {
			recursiveScanCompilationUnits(monitor, elt);
		}
	}

	protected void recursiveScanCompilationUnits(IProgressMonitor monitor, Collection<IJavaElement> elts) throws Exception {
		for (IJavaElement elt : elts) {
			recursiveScanCompilationUnits(monitor, elt);
		}
	}
	...
	protected void recursiveScanCompilationUnits(IProgressMonitor monitor, IJavaElement elt) throws Exception {
