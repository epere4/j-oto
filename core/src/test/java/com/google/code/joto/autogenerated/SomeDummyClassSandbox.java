...
registerInstance( 4354460, obj);  /* @42719c */
...
array[0] = 13;
array[1] = new Date(1252113826248L) /* Fri Sep 04 22:23:46 GMT-03:00 2009*/ ;
array[2] = "lolo";
array[3] = CodeType.RC;
...
registerInstance( 29013258, obj);  /* @1bab50a */
obj.setCommission(0.0);
obj.setTAXCommissionApplicable(true);
return obj;
}}.create();
array[7] = (Vendor) getInstance( 4354460) /* @42719c */ ;
return array;
}}.create());
...
col.add((Vendor) getInstance( 4354460) /* @42719c */ );
col.add(123);
return col;
}}.create());
return obj;
