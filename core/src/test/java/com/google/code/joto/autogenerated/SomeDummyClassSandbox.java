...
registerInstance( 25669322, obj);  /* @187aeca */
obj.setInteger(56);
...
registerInstance( 3195425, obj);  /* @30c221 */
...
registerInstance( 12830537, obj);  /* @c3c749 */
obj.setCommission(0.0);
obj.setTAXCommissionApplicable(true);
return obj;
}}.create();
array[7] = (Vendor) getInstance( 3195425) /* @30c221 */ ;
return array;
}}.create());
...
col.add((Vendor) getInstance( 3195425) /* @30c221 */ );
col.add(123);
return col;
}}.create());
return obj;
